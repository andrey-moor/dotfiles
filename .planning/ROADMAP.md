...
Plans:
- [ ] 01-01-PLAN.md - Document and create encrypted base VM with GRUB
- [ ] 01-02-PLAN.md - Install Omarchy desktop and configure services
- [ ] 01-03-PLAN.md - Generalize template and verify cloning works
...
|-------|----------------|--------|-----------|
| 1. VM Template Creation | 0/3 | Planned | - |
