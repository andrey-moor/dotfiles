...
Wait for VM to boot to LUKS passphrase prompt. Enter passphrase "<passphrase you set>" (from template).

After boot to login prompt, log in as root (password: <passphrase you set>).
