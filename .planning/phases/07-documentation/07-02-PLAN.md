...
must_haves:
  truths:
    - "Troubleshooting is organized by user-observed symptom"
    - "Each issue has root cause and solution"
    - "Prevention tips help avoid future occurrences"
    - "Table of contents enables quick navigation"
  artifacts:
    - path: "docs/TROUBLESHOOTING.md"
      provides: "Consolidated troubleshooting guide"
      contains: "## Symptom:"
  key_links:
    - from: "docs/TROUBLESHOOTING.md"
      to: "hosts/stargazer/README.md"
      via: "back-references to setup steps"
      pattern: "See.*README"
---

<objective>
Create a consolidated troubleshooting guide organized by user-observed symptoms.

Purpose: Users can diagnose issues by what they observe (symptoms) rather than needing to know which component failed.

Output: New `docs/TROUBLESHOOTING.md` that consolidates all troubleshooting from existing docs, reorganized by symptom category.
</objective>
...
<task type="auto">
  <name>Task 1: Create troubleshooting guide structure</name>
  <files>docs/TROUBLESHOOTING.md</files>
  <action>
Create `docs/TROUBLESHOOTING.md` with the following structure:
...
```
  ...
  <verify>head -50 docs/TROUBLESHOOTING.md shows Table of Contents</verify>
  <done>Document structure and ToC created</done>
</task>

<task type="auto">
  <name>Task 2: Add boot and VM issue sections</name>
  <files>docs/TROUBLESHOOTING.md</files>
  <action>
Add the following sections after the Quick Diagnosis section:
...
```
  ...
  <verify>grep -c "^### " docs/TROUBLESHOOTING.md returns at least 9</verify>
  <done>Boot and VM issue sections complete with root causes and solutions</done>
</task>

<task type="auto">
  <name>Task 3: Add Rosetta, Intune, and YubiKey issue sections</name>
  <files>docs/TROUBLESHOOTING.md</files>
  <action>
...
```
  ...
  <verify>grep -c "^### " docs/TROUBLESHOOTING.md returns at least 16</verify>
  <done>All troubleshooting sections complete with symptoms, causes, solutions, and prevention</done>
</task>

</tasks>

<verification>
1. Document has Table of Contents with anchor links
2. Each issue follows format: What you see, Root cause, Solution, Prevention
3. Solutions include copy-pasteable commands
4. Cross-references to setup guide and other docs
5. All issues from existing docs consolidated
</verification>

<success_criteria>
- [ ] `docs/TROUBLESHOOTING.md` exists and is 400+ lines
- [ ] Table of Contents has 5 main sections
- [ ] At least 16 individual issues documented
- [ ] All issues have "Prevention" tips
- [ ] Links to hosts/stargazer/README.md present
</success_criteria>
