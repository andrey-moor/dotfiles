...
<task type="auto">
  ...
  <done>Installation script completed successfully</done>
</task>
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    6. Get VM IP address: `ip addr | grep inet`
    7. From macOS terminal, test SSH: `ssh user@<VM_IP>` (password: temppass)
    8. Verify Rosetta mount: `ls /mnt/psf/RosettaLinux/rosetta`
