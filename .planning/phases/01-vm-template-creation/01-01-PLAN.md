...
<task type="auto">
  ...
  <action>
Add a new "VM Template Creation" section at the BEGINNING of hosts/endurance/README.md, BEFORE the existing "Prerequisites" section. The existing content (Nix installation, Rosetta binfmt, Device Broker, pcscd, Intune compliance, etc.) must be PRESERVED - it documents Phase 2+ setup steps.
...
IMPORTANT: Do NOT delete or modify any existing content below the new section. The existing Prerequisites, Device Broker, pcscd, Intune, Verify, and Troubleshooting sections are Phase 2+ documentation that must remain intact.
  </action>
  <verify>
Read hosts/endurance/README.md and confirm:
- New "VM Template Creation" section exists at the top
- All 7 steps documented with commands
- LUKS2 argon2id syntax correct
- GRUB ARM64 commands present
- mkinitcpio HOOKS documented
- All existing Phase 2+ content preserved (Prerequisites through Troubleshooting)
  </verify>
  <done>VM creation documentation prepended to README without destroying existing Phase 2+ content</done>
</task>
...
- [ ] Existing Phase 2+ documentation preserved intact
</verification>

<success_criteria>
1. hosts/endurance/README.md contains complete VM creation documentation (prepended)
...
5. All existing Phase 2+ content remains intact
</success_criteria>
