...
<task type="auto">
  ...
  <action>
Add to hosts/endurance/README.md after the base installation section (within the VM Template Creation section, before the existing Prerequisites section):
...
IMPORTANT: Insert this content AFTER the VM Template Creation section (Steps 1-7) but BEFORE the existing Prerequisites section. The existing Phase 2+ content must remain intact.
  </action>
  <verify>
