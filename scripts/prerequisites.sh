...
echo ""
echo "Next steps:"
echo "  1. Apply home-manager: cd ~/dotfiles && nix run home-manager -- switch --flake .#stargazer -b backup"
echo "  2. Run intune-prerequisites"
echo "  3. Complete remaining setup in hosts/stargazer/README.md"
