...
echo ""
echo "Next steps:"
echo "  1. Apply home-manager: cd /mnt/psf/Home/Documents/dotfiles && nix run home-manager -- switch --flake .#stargazer -b backup"
echo "  2. Complete remaining setup in hosts/stargazer/README.md (Device Broker, pcscd, etc.)"
