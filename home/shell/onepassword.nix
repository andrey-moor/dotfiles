# home/shell/onepassword.nix -- 1Password SSH agent integration
...
with lib;
{
  ...
  config = {
    ...
    home.file.".ssh/1p_personal.pub".text =
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICdtwwW6A7j8vesJzYxp06VugC0Go+q1rBCbTXbCzSfs";
    home.file.".ssh/1p_microsoft.pub".text =
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJIvYOLXV0u6EZgw96emCgaMBCYGQLkiW7lJKmYZTfc/";
    home.file.".ssh/1p_linkedin.pub".text =
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJtI2UYmOcRkM+PrENRzpRB+4Nzj1Xj8/7tsXfHelBhY";
